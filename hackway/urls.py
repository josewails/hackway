...
urlpatterns = [
    ...
    url(r'^facebook_users$', FacebookUserListAPIView.as_view(),name='facebook_users_list' ),
    url(r'^facebook_users/(?P<facebook_id>[\w]+)/$', FacebookUserRetrieveAPIView.as_view()),
    url(r'^facebook_users/(?P<facebook_id>[\w]+)/update$', FacebookUserUpdateAPIView.as_view(), name='update_facebook_user'),
    url(r'^facebook_users/(?P<facebook_id>[\w]+)/delete$', FacebookUserDeleteAPIView.as_view()),
    url(r'^coding_questions/create$', CodingQuestionCreate.as_view(), name='create_coding_question'),
    url(r'^coding_questions$', CodingQuestionListAPIView.as_view(), name='all_coding_questions'),
    ...
    url(r'^programming_questions$', ProgrammingLanguagesList.as_view(), name='all_programming_languages'),
